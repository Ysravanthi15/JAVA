<h2><a href="https://www.geeksforgeeks.org/problems/sort-an-arraylist/1?page=3&category=Java&status=unsolved&sortBy=latest">Sort An ArrayList</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given an integer arrayList <strong>list</strong>, you need to sort it in increasing order.</span></p>
