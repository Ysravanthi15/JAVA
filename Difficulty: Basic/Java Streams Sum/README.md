<h2><a href="https://www.geeksforgeeks.org/problems/java-streams-sum/1?page=2&category=Java&difficulty=Basic&status=unsolved&sortBy=submissions">Java Streams Sum</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an integer array <strong>arr[]</strong>. The task is to find the sum of the array using streams.</span></p>
